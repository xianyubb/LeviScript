...
// --- real LeviLamina header, auto-generated binding -----------------------
// ll/api/data/Version.h -> ll.Version (generated by tools/autobind, merged into
// the hand-written `ll` namespace). Exercises the default constructor, uint16_t
// and optional<string> data-member properties, and a `const noexcept` method.
const v = new ll.Version();          // default ctor -> 0.1.0
v.major = 26; v.minor = 40; v.patch = 0;
v.build = "generated";
logger.info("ll.Version to_string() =", v.to_string());
const v2 = new ll.Version();
v2.major = 26; v2.minor = 40; v2.patch = 0;
logger.info("v.isIdenticalTo(v2) =", v.isIdenticalTo(v2));   // false: build differs
v2.build = "generated";
logger.info("after matching build, isIdenticalTo =", v.isIdenticalTo(v2)); // true
logger.info("ll.Version fields =", v.major, v.minor, v.patch, v.build);
